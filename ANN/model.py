...
class neuralNetwork:
    ...
    def __init__(self, inputnodes, hidden1nodes, hidden2nodes, outputnodes,
                 learningrate):
        ...
        self.wih = (numpy.random.rand(self.h1nodes, self.inodes) - 0.5)
        self.whh = (numpy.random.rand(self.h2nodes, self.h1nodes) - 0.5)
        self.who = (numpy.random.rand(self.onodes, self.h2nodes) - 0.5)
    ...
    def train(self, inputs_list, targets_list):
        ...
        self.who += self.lr * numpy.dot(
            (output_errors * final_outputs *
             (1.0 - final_outputs)), numpy.transpose(hidden2_outputs))
        # update the weights for the links between the input and hidden layers
        self.wih += self.lr * numpy.dot(
            (hidden_errors * hidden2_outputs *
             (1.0 - hidden2_outputs)), numpy.transpose(inputs))
